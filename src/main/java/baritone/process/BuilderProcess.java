...
//    }
     ...
     *
     * @parami index reference to the schematic placement list.
     */
//    @Override
...
//    }
    ...
    private Optional<Placement> possibleToPlace(IBlockState toPlace, int x, int y, int z, BlockStateInterface bsi) {
        for (EnumFacing against : EnumFacing.values()) {
            ...
            AxisAlignedBB aabb = placeAgainstState.getBlock().getCollisionBoundingBox(ctx.world(), placeAgainstPos, placeAgainstState);
