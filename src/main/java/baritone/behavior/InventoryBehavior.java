...
import baritone.api.utils.ClickType;
...
public final class InventoryBehavior extends Behavior implements Helper {
    ...
    private boolean requestSwapWithHotBar(int inInventory, int inHotbar) {
        ...
        ctx.playerController().windowClick(ctx.player().inventoryContainer.windowId, inInventory < 9 ? inInventory + 36 : inInventory, inHotbar, ClickType.SWAP.ordinal(), ctx.player());
